...
type GetTaskByUserIDRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetTaskByUserIDRequest) Reset() {
	*x = GetTaskByUserIDRequest{}
	mi := &file_proto_task_task_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetTaskByUserIDRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetTaskByUserIDRequest) ProtoMessage() {}

func (x *GetTaskByUserIDRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_task_task_proto_msgTypes[11]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetTaskByUserIDRequest.ProtoReflect.Descriptor instead.
func (*GetTaskByUserIDRequest) Descriptor() ([]byte, []int) {
	return file_proto_task_task_proto_rawDescGZIP(), []int{11}
}

func (x *GetTaskByUserIDRequest) GetUserId() uint32 {
	if x != nil {
		return x.UserId
	}
	return 0
...
type GetTaskByUserIDResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Tasks         []*Task                `protobuf:"bytes,1,rep,name=tasks,proto3" json:"tasks,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *GetTaskByUserIDResponse) Reset() {
	*x = GetTaskByUserIDResponse{}
	mi := &file_proto_task_task_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetTaskByUserIDResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetTaskByUserIDResponse) ProtoMessage() {}

func (x *GetTaskByUserIDResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_task_task_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetTaskByUserIDResponse.ProtoReflect.Descriptor instead.
func (*GetTaskByUserIDResponse) Descriptor() ([]byte, []int) {
	return file_proto_task_task_proto_rawDescGZIP(), []int{12}
}

func (x *GetTaskByUserIDResponse) GetTasks() []*Task {
	if x != nil {
		return x.Tasks
	}
	return nil
...
const file_proto_task_task_proto_rawDesc = "" +
	...
	"\auser_id\x18\x04 \x01(\rR\x06userId\"Y\n" +
	...
	"\x16GetTaskByUserIDRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\rR\x06userId\";\n" +
	"\x17GetTaskByUserIDResponse\x12 \n" +
	"\x05tasks\x18\x01 \x03(\v2\n" +
	".task.TaskR\x05tasks2\x97\x03\n" +
	"\vTaskService\x12?\n" +
	"\n" +
	...
	"\n" +
	"DeleteTask\x12\x17.task.DeleteTaskRequest\x1a\x18.task.DeleteTaskResponse\x12O\n" +
	"\x10GetTasksByUserID\x12\x1c.task.GetTaskByUserIDRequest\x1a\x1d.task.GetTaskByUserIDResponseB*Z(github.com/Suhach/protoc-cont/proto/taskb\x06proto3"
...
var file_proto_task_task_proto_goTypes = []any{
	...
	(*GetTaskByUserIDRequest)(nil),  // 11: task.GetTaskByUserIDRequest
	(*GetTaskByUserIDResponse)(nil), // 12: task.GetTaskByUserIDResponse
}
var file_proto_task_task_proto_depIdxs = []int32{
	...
	0,  // 4: task.GetTaskByUserIDResponse.tasks:type_name -> task.Task
	...
	11, // 10: task.TaskService.GetTasksByUserID:input_type -> task.GetTaskByUserIDRequest
	...
	12, // 16: task.TaskService.GetTasksByUserID:output_type -> task.GetTaskByUserIDResponse
